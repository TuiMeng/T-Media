...
-(void)initializeViewComponents{
    ...
    kSkipButtonFont = [UIFont systemFontOfSize:13];
    ...
    self.RightSkipButton.frame = CGRectMake(self.frame.size.width - skipStringWidth - kLeftRightSkipPadding, 5, skipStringWidth, 37);
