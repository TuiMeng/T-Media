...
-(void)buildPanelWithFrame:(CGRect)frame{
    ...
    */
    ...
    if (self.PanelImageView.image) {
        self.PanelImageView.frame = self.bounds;//CGRectMake(kLeftRightMargins, runningYOffset, self.frame.size.width - 2*kLeftRightMargins, self.frame.size.height - runningYOffset - kBottomPadding);
        self.PanelImageView.contentMode = UIViewContentModeScaleAspectFill;
