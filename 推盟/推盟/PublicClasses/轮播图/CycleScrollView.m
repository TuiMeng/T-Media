...
- (id)initWithFrame:(CGRect)frame animationDuration:(NSTimeInterval)animationDuration WithDataArray:(NSMutableArray *)dataArray
{
    ...
    if (animationDuration > 0.0 && _data_array.count > 1) {
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(DEVICE_WIDTH-80,0,60,20)];
...
-(void)setupAllViews
{
    ...
    for (int i = 0;i < _totalPageCount;i++)
    {
        ...
        [imageView sd_setImageWithURL:[NSURL URLWithString:model.c_image_url] placeholderImage:[UIImage imageNamed:@"default_loading_big_image"]];
