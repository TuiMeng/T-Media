...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        //任务总额
        if (!_bonus_label) {
            _bonus_label = [ZTools createLabelWithFrame:CGRectMake(_headerImageView.right+10, _title_label.bottom+10, _title_label.width, 20) tag:100 text:@"" textColor:RGBCOLOR(95, 95, 95) textAlignment:NSTextAlignmentLeft font:17];
